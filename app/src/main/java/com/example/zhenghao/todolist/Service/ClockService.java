package com.example.zhenghao.todolist.Service;
...
import com.example.zhenghao.todolist.Activity.ClockActivity;
import com.example.zhenghao.todolist.Dao.ClockDao;
import com.example.zhenghao.todolist.Bean.Clock;
import com.example.zhenghao.todolist.Utils.CountDownTimer;
import com.example.zhenghao.todolist.Utils.NetWorkUtils;
import com.example.zhenghao.todolist.Utils.SPUtils;
import com.example.zhenghao.todolist.Utils.Sound;
import com.example.zhenghao.todolist.Utils.TimeFormatUtil;
import com.example.zhenghao.todolist.Bean.User;
import com.example.zhenghao.todolist.Utils.WakeLockHelper;
import com.example.zhenghao.todolist.Widget.ClockApplication;
...
public class ClockService extends Service implements CountDownTimer.OnCountDownTickListener {
    public static final String ACTION_COUNTDOWN_TIMER =
            "com.example.zhenghao.todolist.COUNTDOWN_TIMER";
    public static final String ACTION_START = "com.example.zhenghao.todolist.ACTION_START";
    public static final String ACTION_PAUSE = "com.example.zhenghao.todolist.ACTION_PAUSE";
    public static final String ACTION_RESUME = "com.example.zhenghao.todolist.ACTION_RESUME";
    public static final String ACTION_STOP = "com.example.zhenghao.todolist.ACTION_STOP";
    public static final String ACTION_TICK = "com.example.zhenghao.todolist.ACTION_TICK";
    public static final String ACTION_FINISH = "com.example.zhenghao.todolist.ACTION_FINISH";
    public static final String ACTION_AUTO_START
            = "com.example.zhenghao.todolist.ACTION_AUTO_START";
    public static final String ACTION_TICK_SOUND_ON =
            "com.example.zhenghao.todolist.ACTION_TICK_SOUND_ON";
    public static final String ACTION_TICK_SOUND_OFF =
            "com.example.zhenghao.todolist.ACTION_TICK_SOUND_OFF";
    public static final String ACTION_POMODORO_MODE_ON =
            "com.example.zhenghao.todolist.ACTION_POMODORO_MODE_OFF";
    public static final String ACTION_CHANGE_MUSIC = "com.example.zhenghao.todolist.ACTION_CHANGE_MUSIC";
